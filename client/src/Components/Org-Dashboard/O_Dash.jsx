...
<path d="M24.5483 21.0938L20.6665 24.9634L19.5679 23.8647L21.5576 21.875H14.0625V20.3125H21.5576L19.5679 18.3228L20.6665 17.2241L24.5483 21.0938ZM16.9312 23.4375L18.4937 25H3.125V3.125H9.375C9.375 2.69368 9.45638 2.29085 9.61914 1.9165C9.7819 1.54215 10.0057 1.2085 10.2905 0.915527C10.5754 0.622559 10.9049 0.398763 11.2793 0.244141C11.6536 0.0895182 12.0605 0.00813802 12.5 0C12.9313 0 13.3341 0.0813802 13.7085 0.244141C14.0828 0.406901 14.4165 0.630697 14.7095 0.915527C15.0024 1.20036 15.2262 1.52995 15.3809 1.9043C15.5355 2.27865 15.6169 2.68555 15.625 3.125H21.875V16.2231L20.3125 14.6606V4.6875H18.75V7.8125H6.25V4.6875H4.6875V23.4375H16.9312ZM7.8125 4.6875V6.25H17.1875V4.6875H14.0625V3.125C14.0625 2.90527 14.0218 2.70182 13.9404 2.51465C13.859 2.32747 13.7492 2.16471 13.6108 2.02637C13.4725 1.88802 13.3057 1.77409 13.1104 1.68457C12.915 1.59505 12.7116 1.55436 12.5 1.5625C12.2803 1.5625 12.0768 1.60319 11.8896 1.68457C11.7025 1.76595 11.5397 1.87581 11.4014 2.01416C11.263 2.15251 11.1491 2.31934 11.0596 2.51465C10.9701 2.70996 10.9294 2.91341 10.9375 3.125V4.6875H7.8125Z" fill="white"/>
</svg>
            </div>
      ...
      <div className="rightrectangle  m-1  h-full w-full flex-col rounded-md max-lg:w-4/5">
        ...
        <div className="totalbadges text-white font-bold w-1/5 h-1/4 my-16 rounded-md text-center flex-col  items-center max-lg:my-1" >
             <img className= "first items-center"src={teach} alt="" width={'140px'}/>
            </div>
          <div className="totalbadges text-white font-bold w-1/5 h-full my-16 bg-teal-600 rounded-md text-center flex-col  items-center max-lg:my-2" data-aos="zoom-in">
              <p className="number text-6xl my-2 max-lg:my-0 max-lg:text-2xl ">{badgedata.length}</p>
