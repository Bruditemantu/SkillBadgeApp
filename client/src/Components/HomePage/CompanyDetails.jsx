          ...
          <div className="flex flex-col lg:mx-2 lg:flex-row justify-evenly">
            ...
            <div>
              <div className="px-5 lg:px-0">
                <h2 className="text-2xl">Brudite Private Limited</h2>
              </div>
              ...
              {/* subscribe model */}
              <div className="px-5 lg:px-0 text-center flex flex-col text-3xl mt-6 mx-3 ">
                <input type="email" className="text-black w-2/3"></input>
                <button className="text-black text-xl  mb-5 lg:mb-0 py-1 w-2/3 text-center duration-200 hover:text-white rounded-xl mt-5  bg-teal-300 hover:bg-teal-700 px-1">
                  Submit
                </button>
              </div>
            </div>
